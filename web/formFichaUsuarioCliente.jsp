            ...
            <div class="form-row">
                <div class="form-group col-md-4">
                    <div class="card" style="width: 18rem;">
                        <a href="imagen?id=<%=a.getId_cliente()%>" target="_blank"><img class="card-img-top" src="Imagen/perfil.jpg"></a>
                        <div class="card-body">
                ...
                <div class="form-group col-md-8">
                    <form action="ServletImagen" method="post" enctype="multipart/form-data">
                        ...
                        <br>  <input type="submit" class="btn btn-outline-success" value="enviar"  name="Registrarse" />
