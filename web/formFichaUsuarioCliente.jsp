...
<html>
    ...
    <div class="contenido">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item" hidden=""><a href="#"><%=d.getId_usu_clie()%></a></li>
                <li class="breadcrumb-item"><a href="#"> Bienvenido:    <%=d.getCorreo()%></a></li>
                <li class="breadcrumb-item active" aria-current="page">Fecha Creacion: <%=d.getFecha_creacion()%></li>
            </ol>
        </nav>
        <%-- 
                        ...
                        <center>
                            ...
                            <form action="ServletClientes" method="get">
                                ...
                                <div class="form-group">
                                    <input type="text"   name="txtId_cliente"  hidden="" value="<%=d.getId_usu_clie()%>">
                                    ...
                                    <input type="text" name="txtNombre1" class="form-control" id="exampleFormControlInput1" >

                                    <label for="exampleFormControlInput1">SEGUNDO NOMBRE</label>
                                    <input type="text" name="txtNombre2" class="form-control" id="exampleFormControlInput1" >

                                    <label for="exampleFormControlInput1">PRIMER APELLIDO</label>
                                    <input type="text" name="txtApellido1" class="form-control" id="exampleFormControlInput1" >

                                    <label for="exampleFormControlInput1">SEGUNDO APELLIDO</label>
                                    <input type="text" name="txtApellido2" class="form-control" id="exampleFormControlInput1" >

                                    <label for="exampleFormControlInput1">FECHA NACIMIENTO</label>
                                    <input type="date" name="txtNacimiento" class="form-control" id="exampleFormControlInput1" >

                                    <label for="exampleFormControlInput1">EDAD</label>
                                    <input type="int" name="txtEdad" class="form-control" id="exampleFormControlInput1" >

                                    <div class="form-group">
                                        <label for="exampleFormControlSelect1">PAIS</label>
                                        <select class="form-control" name="txtPais" id="exampleFormControlSelect1">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="txtDepartamento" id="exampleFormControlSelect1">
                                    ...
                                    <input type="text" name="txtRecidencia" class="form-control"
                                    ...
                                    <input type="number" name="txtRecidencial" class="form-control"


                                           <label for="exampleFormControlInput1">Email address</label>
                                    <input type="email" name="txtCorreo" class="form-control" id="exampleFormControlInput1" placeholder="name@example.com">
